...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "CF-SaaS-Admin-Template":

```bash
npx wrangler d1 create CF-SaaS-Admin-Template
```
